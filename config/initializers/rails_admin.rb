# RailsAdmin config file. Generated on March 15, 2012 14:55
...
RailsAdmin.config do |config|
  ...
  config.authorize_with do
    redirect_to '/' unless current_user.twitter_id == 8314922
  end
  ...
  config.main_app_name = ['Kulaverse', 'Admin']
  ...
  #     configure :name, :string 
  #     configure :twitter_id, :integer 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  #     configure :facebook_id, :integer   #   # Sections:
  #   list do; end
  #   export do; end
  #   show do; end
  #   edit do; end
